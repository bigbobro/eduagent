...
- 添加新课程:先读 `docs/course-authoring-standard.md`;在 `src/data/courses/<id>.ts` 新建 `Course` 对象,append 到 `src/data/courses/transportation.ts` 底部的 `allCourses` 数组,并补课程专属校验。
