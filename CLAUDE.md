...
- 添加新课程:在 `src/data/courses/<id>.ts` 新建 `Course` 对象,append 到 `src/data/courses/transportation.ts` 底部的 `allCourses` 数组。三阶段课程(有 `phases` 字段)的产出清单见 `docs/superpowers/specs/2026-05-15-lesson-structure-refactor-design.md` §13
