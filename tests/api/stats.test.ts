...
describe('/api/stats', () => {
  ...
  it('totalWordsMastered matches progress aggregator', async () => {
    memDb.prepare(`INSERT INTO lesson_logs (id, course_id, start_time, end_time, interaction_count, token_usage) VALUES ('l1','food','2026-05-10T10:00:00Z','2026-05-10T10:30:00Z',3,'{}')`).run();
