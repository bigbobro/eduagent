...
| [Agent Layer](./agent-layer.md) | memory/session/prompt contracts: actions timing, ASR verify, R5/R7 (legacy, superseded by R-C 2026-05-23), R6 closing guard currentWord exempt, state_update schema (R-C server-authoritative), Guard Pipeline (R-D 2026-05-24 — GuardFn[] in src/lib/agent/guards/), prompt input quantification, test fixtures & mocks | Filled |
