...
![上课主界面 / Teaching screen](docs/screenshots/03-lesson-teaching.png)

课程选择与课前预告 / Course picker and pre-lesson preview:

| 魔法书房(选课) / Course picker | 课前预告 / Lesson preview |
| --- | --- |
| ![选课页 / Course picker](docs/screenshots/01-home.png) | ![课前预告 / Lesson preview](docs/screenshots/02-lesson-preview.png) |

我的魔法书 —— 已收集的词按课程分章展示。
The spellbook: collected words, grouped by course.

![魔法书 / Spellbook](docs/screenshots/04-journal.png)
